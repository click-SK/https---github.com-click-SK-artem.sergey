...
const EditClientDashki = () => {
    ...
    useEffect(() => {
      ...
      const handleAddNewType = () => {    
        fetch('https://sklo-expert.herokuapp.com/add-new-client-dashki-type', {
          method: 'PATCH',
          headers: {
        ...
        <div>
          <AdminHeader/>
            ...
            {showTypeBlock && currentObject?.typeWordpress && currentObject.typeWordpress.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert.herokuapp.com/update-client-dashki-type'
                pathDelete='https://sklo-expert.herokuapp.com/remove-client-dashki-type'/>
            ))
            }
            {showTypeBlock && 
            <>
