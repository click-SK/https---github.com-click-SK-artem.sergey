...
const EditClientCosmeticMirror = () => {
    ...
    useEffect(() => {
      ...
      const handleAddNewType = () => {    
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-client-cosmetic-mirrors-type', {
          method: 'PATCH',
          headers: {
        ...
        <div>
          <AdminHeader/>
            ...
            {showTypeBlock && currentObject?.typeWordpress && currentObject.typeWordpress.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-client-cosmetic-mirrors-type'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-client-cosmetic-mirrors-type'
                pathEditPhoto='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-client-cosmetic-mirrors-type-image'/>
            ))
            }
            {showTypeBlock && 
            <>
