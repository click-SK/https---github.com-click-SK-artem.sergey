...
const EditClientGlassPartition = () => {
    ...
    useEffect(() => {
      ...
      const handleAddNewType = () => {    
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-client-glass-partitions-type', {
          method: 'PATCH',
          headers: {
        ...
        <div>
          <AdminHeader/>
            ...
            {showTypeBlock && currentObject?.typeWordpress && currentObject.typeWordpress.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-client-glass-partitions-type'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-client-glass-partitions-type'/>
            ))
            }
            {showTypeBlock && 
            <>
