...
const EditDashki = () => {
    ...
    useEffect(() => {
      ...
      const handleAddNewFurniture = () => {
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-furniture', {
            method: 'PATCH',
            headers: {
      ...
      const handleAddNewType = () => {    
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-dashki-type', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewColor = () => {
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-dashki-color', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewProcessingStandart = () => {
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-dashki-processing-standart', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewProcessingСutout = () => {
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-dashki-processing-cutout', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
        ...
        <div>
          <AdminHeader/>
            ...
            {currentObject?.furniture && showFurnitureBlock && currentObject.furniture.map((el, furnitureIdx) => (
                ...
                pathUpdateMainImg='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-furniture-main-image'
                pathUpdateSecondImg='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-furniture-second-image'
                pathUpdateTitle='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-furniture-title'
                pathAddNewDepends='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-furniture-depends'
                pathAddNewColors='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-dashki-furniture-colors'
                pathDeleteFurniture='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-dashki-furniture'
                pathUpdateFurnitureColors='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-furniture-color'
                pathDeleteFurnitureColors='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-dashki-furniture-colors'
                pathUpdateFurnituredepends='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-furniture-depends'
                pathDeleteFurnituredepends='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-furniture-depends'
                />
            ))}
            ...
            {showTypeBlock && currentObject.typeGlass.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-type'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-dashki-type'
                setIsFetch={setIsFetch}/>
            ))
            }
            {showTypeBlock && 
            ...
            {showSizeBlock && currentObject.size.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-size'
                setIsFetch={setIsFetch}/>
            ))
            }
            {showColorBlock && currentObject.color.map((el, idx) => (
                <O_EditColorTemplate el={el} key={idx} showerId={currentObject._id}
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-color'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-dashki-color'
                setIsFetch={setIsFetch}/>
            ))
            }
            {showColorBlock &&
          ...
          {showProcessingStandartBlock && currentObject.processingStandart.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-processing-standart'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-dashki-processing-standart'
                setIsFetch={setIsFetch}/>
            ))
            }
            ...
            {showProcessingСutoutBlock && currentObject.processingСutout.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-dashki-processing-cutout'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-dashki-processing-cutout'
                setIsFetch={setIsFetch}/>
            ))
            }
