...
const EditShower = () => {
  ...
  const handleAddNewFurniture = () => {
    fetch("https://sklo-expert.herokuapp.com/add-new-furniture", {
      method: "PATCH",
      headers: {
  ...
  const handleAddNewColors = () => {
    ...
    fetch("https://sklo-expert.herokuapp.com/update-shower-colors", {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleAddNewGlassThicknes = () => {
    fetch("https://sklo-expert.herokuapp.com/add-new-glass-thickness", {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleAddNewType = () => {
    fetch("https://sklo-expert.herokuapp.com/add-new-shower-type", {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleAddNewProcessingStandart = () => {
    fetch('https://sklo-expert.herokuapp.com/add-new-shower-processing-standart', {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleAddNewProcessingСutout = () => {
    fetch('https://sklo-expert.herokuapp.com/add-new-shower-processing-cutout', {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    <div>
      ...
      {currentObject?.furniture &&
        ...
        currentObject.furniture.map((el, furnitureIdx) => (
          <O_EditFurnitureTemplate
            ...
            showerId={currentObject._id}
            pathUpdateMainImg="https://sklo-expert.herokuapp.com/update-shower-furniture-main-image"
            pathUpdateSecondImg="https://sklo-expert.herokuapp.com/update-shower-furniture-second-image"
            pathUpdateTitle="https://sklo-expert.herokuapp.com/update-shower-furniture-title"
            pathAddNewDepends="https://sklo-expert.herokuapp.com/update-shower-furniture-depends"
            pathAddNewColors="https://sklo-expert.herokuapp.com/add-new-shower-furniture-colors"
            pathDeleteFurniture="https://sklo-expert.herokuapp.com/remove-shower-furniture"
            pathUpdateFurnitureColors="https://sklo-expert.herokuapp.com/update-shower-furniture-color"
            pathDeleteFurnitureColors="https://sklo-expert.herokuapp.com/remove-shower-furniture-colors"
            pathUpdateFurnituredepends="https://sklo-expert.herokuapp.com/update-shower-furniture-depends"
            pathDeleteFurnituredepends="https://sklo-expert.herokuapp.com/update-shower-furniture-depends"
      ...
      {currentObject?.color &&
        ...
        currentObject.color.map((el, idx) => (
          <A_EditColorsTemplate
            ...
            showerId={currentObject._id}
            setIsFetch={setIsFetch}
            pathDelete="https://sklo-expert.herokuapp.com/update-shower-colors"
            pathEdit="https://sklo-expert.herokuapp.com/update-shower-colors"
          />
        ))}
      ...
      {currentObject?.type &&
        ...
        currentObject.type.map((el, idx) => (
            ...
            showerId={currentObject._id}
            setIsFetch={setIsFetch}
            pathDelete="https://sklo-expert.herokuapp.com/remove-shower-type"
            pathEdit="https://sklo-expert.herokuapp.com/update-shower-type"
          />
        ))}
      ...
      {currentObject?.sizeOfTheShower &&
        ...
        currentObject.sizeOfTheShower.map((el, idx) => (
          <O_EditSizeTemplate
            ...
            key={idx}
            setIsFetch={setIsFetch}
            pathEdit="https://sklo-expert.herokuapp.com/update-shower-size"
          />
        ))}
            ...
            {showProcessingStandartBlock && currentObject.processingStandart.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert.herokuapp.com/update-shower-processing-standart'
                pathDelete='https://sklo-expert.herokuapp.com/remove-shower-processing-standart'
                setIsFetch={setIsFetch}/>
            ))
            }
            ...
            {showProcessingСutoutBlock && currentObject.processingСutout.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert.herokuapp.com/update-shower-processing-cutout'
                pathDelete='https://sklo-expert.herokuapp.com/remove-shower-processing-cutout'
                setIsFetch={setIsFetch}/>
            ))
            }
