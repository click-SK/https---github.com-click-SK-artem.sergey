...
const EditShowerMirrorsTemplate = ({el, showerId, setIsFetch}) => {
    ...
    const handleEditButton = () => {
      ...
      const handleEditButtonSave = () => {
        ...
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-shower-color', {
          method: 'PATCH',
          headers: {
      ...
      const handleDelete = () => {
        fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-shower-glass-thickness', {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json'
          },
