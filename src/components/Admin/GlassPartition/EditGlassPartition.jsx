...
const EditGlassPartition = () => {
    ...
    const handleAddNewProcessingStandart = () => {
        fetch('https://sklo-expert.herokuapp.com/add-new-glass-partitions-processing-standart', {
          method: 'PATCH',
          headers: {
      ...
      const handleAddNewProcessingСutout = () => {
        fetch('https://sklo-expert.herokuapp.com/add-new-glass-partitions-processing-cutout', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewColor = () => {
        fetch('https://sklo-expert.herokuapp.com/add-new-glass-partitions-color', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewType = () => {    
        fetch('https://sklo-expert.herokuapp.com/add-new-glass-partitions-type', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewColors = () => {
        ...
        fetch('https://sklo-expert.herokuapp.com/update-glass-partitions-colors', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const handleAddNewFurniture = () => {
        fetch('https://sklo-expert.herokuapp.com/glass-partitions-add-furniture', {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
        ...
        <div>
          <AdminHeader/>
            ...
            {currentObject?.furniture && showFurnitureBlock && currentObject.furniture.map((el, furnitureIdx) => (
                ...
                pathUpdateMainImg='https://sklo-expert.herokuapp.com/update-glass-partitions-furniture-main-image'
                pathUpdateSecondImg='https://sklo-expert.herokuapp.com/update-glass-partitions-furniture-second-image'
                pathUpdateTitle='https://sklo-expert.herokuapp.com/update-glass-partitions-furniture-title'
                pathAddNewDepends='https://sklo-expert.herokuapp.com/update-glass-partitions-furniture-depends'
                pathAddNewColors='https://sklo-expert.herokuapp.com/add-new-glass-partitions-furniture-colors'
                pathDeleteFurniture='https://sklo-expert.herokuapp.com/remove-glass-partitions-furniture'
                pathUpdateFurnitureColors='https://sklo-expert.herokuapp.com/glass-partitions-update-furniture-color'
                pathDeleteFurnitureColors='https://sklo-expert.herokuapp.com/remove-glass-partitions-furniture-colors'
                pathUpdateFurnituredepends='https://sklo-expert.herokuapp.com/update-glass-partitions-furniture-depends'
                pathDeleteFurnituredepends='https://sklo-expert.herokuapp.com/update-glass-partitions-furniture-depends'
                />
            ))}
            ...
            {showColorBlock && currentObject.color.map((el, idx) => (
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert.herokuapp.com/update-glass-partitions-color'
                pathDelete='https://sklo-expert.herokuapp.com/remove-glass-partitions-color'/>
            ))
            }
            {showColorBlock &&
            <>
            ...
            {showProcessingStandartBlock && currentObject.processingStandart.map((el, idx) => (
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert.herokuapp.com/update-glass-partitions-processing-standart'
                pathDelete='https://sklo-expert.herokuapp.com/remove-glass-partitions-processing-standart'/>
            ))
            }
            ...
            {showProcessingСutoutBlock && currentObject.processingСutout.map((el, idx) => (
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert.herokuapp.com/update-glass-partitions-processing-cutout'
                pathDelete='https://sklo-expert.herokuapp.com/remove-glass-partitions-processing-cutout'/>
            ))
            }
            ...
            {showSizeBlock && currentObject.size.map((el, idx) => (
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert.herokuapp.com/update-glass-partitions-size'/>
            ))
            }
            {showTypeBlock && currentObject.typeGlass.map((el, idx) => (
                <O_EditTypeTemplate el={el} key={idx} showerId={currentObject._id}
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert.herokuapp.com/update-glass-partitions-type'
                pathDelete='https://sklo-expert.herokuapp.com/remove-glass-partitions-type'/>
            ))
            }
            {showTypeBlock && 
            <>
            ...
            {showTypePartitionBlock && currentObject.typePartitions.map((el, idx) => (
                 ...
                 setIsFetch={setIsFetch}
                 pathDelete='https://sklo-expert.herokuapp.com/update-glass-partitions-colors'
                 pathEdit='https://sklo-expert.herokuapp.com/update-glass-partitions-colors'
                 />
            ))
            }
