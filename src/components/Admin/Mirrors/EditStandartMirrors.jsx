...
const EditStandartMirrors = () => {
  ...
  const handleAddNewColor = () => {    
    fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-mirror-color', {
      method: 'PATCH',
      headers: {
  ...
  const handleAddNewSwitch = () => {    
    fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-mirror-switch', {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleAddNewBackLight = () => {    
    fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-mirror-backlight', {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleAddNewFrame = () => {    
    fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-mirror-frame', {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleAddNewProcessingСutout = () => {
    fetch('https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-standart-mirror-processing-cutout', {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    <div>
      <AdminHeader/>
        ...
        currentObject?.type.map((item, idxType) => (
          ...
          updateTypePath='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-type'
          addNewGoodsPath='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/add-new-goods'
          updateGoodsPath='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-goods'
          deleteGoodsPath='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-mirror-goods'/>
        ))}
        {showFrameBlock && 
        currentObject?.option?.frame.map((el, idx) => (
          <O_NamePriceTemplate el={el} key={idx} showerId={currentObject._id}
          setIsFetch={setIsFetch}
          pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-frame'
          pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-mirror-frame'/>
        ))}
            {showFrameBlock && 
            <>
        ...
        currentObject?.option?.backLight.map((el, idx) => (
          <O_NamePriceTemplate el={el} key={idx} showerId={currentObject._id}
          setIsFetch={setIsFetch}
          pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-backlight'
          pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-mirror-backlight'/>
        ))}
            {showBackLightBlock && 
            <>
        ...
        currentObject?.option?.switch.map((el, idx) => (
          <O_NamePriceTemplate el={el} key={idx} showerId={currentObject._id}
          setIsFetch={setIsFetch}
          pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-switch'
          pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-mirror-switch'/>
        ))}
            {showSwitchBlock && 
            <>
        ...
        currentObject?.option?.color.map((el, idx) => (
          <O_NamePriceTemplate el={el} key={idx} showerId={currentObject._id}
          setIsFetch={setIsFetch}
          pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-color'
          pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-mirror-color'/>
        ))}
            {showColorsBlock && 
            <>
            ...
            {showCordBlock &&
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-cord-price'
                showerId={currentObject?._id}/>
            }
            ...
            {showWarmedUpBlock &&
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-warmed-up-price'
                showerId={currentObject?._id}/>
            }
            ...
            {showPaintingBlock &&
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-mirror-painting-price'
                showerId={currentObject?._id}/>
            }
            {showProcessingСutoutBlock && currentObject.processingСutout.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/update-standart-mirror-processing-cutout'
                pathDelete='https://sklo-expert-server-v2-9a33eddf90a1.herokuapp.com/remove-standart-mirror-processing-cutout'
                setIsFetch={setIsFetch}/>
            ))
            }
