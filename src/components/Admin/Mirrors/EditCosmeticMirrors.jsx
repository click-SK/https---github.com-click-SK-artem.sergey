...
const EditCosmeticMirrors = () => {
    ...
    useEffect(() => {
      ...
      const handleAddNewProcessingСutout = () => {
        fetch('https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/add-new-cosmetic-mirrors-processing-cutout', {
          method: 'PATCH',
          headers: {
      ...
      const handleAddNewType = () => {    
        fetch('https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/add-new-cosmetic-mirrors-type', {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json'
          },
        ...
        <div>
          <AdminHeader/>
            ...
            {showProcessingСutoutBlock && currentObject.processingСutout && currentObject.processingСutout.map((el, idx) => (
                ...
                pathEdit='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/update-cosmetic-mirrors-processing-cutout'
                pathDelete='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/remove-cosmetic-mirrors-processing-cutout'/>
            ))
            }
            ...
            {showTypeBlock && currentObject.typeGlass.map((el, idx) => (
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/update-cosmetic-mirrors-type'
                pathDelete='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/remove-cosmetic-mirrors-type'
                pathEditPhoto='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/update-cosmetic-mirrors-type-image'/>
            ))
            }
            {showTypeBlock && 
            <>
            ...
            {showSizeBlock && currentObject.size.map((el, idx) => (
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/update-cosmetic-mirrors-size'/>
            ))
            }
            ...
            {showLightBulbsBlock &&
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/update-cosmetic-mirrors-light-bulbs'
            ...
            {showPatronBlock &&
                ...
                setIsFetch={setIsFetch}
                pathEdit='https://sklo-expert-server-v2-008be2d9257c.herokuapp.com/update-cosmetic-mirrors-patron'
